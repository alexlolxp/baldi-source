...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'baldi':
				tex = Paths.getSparrowAtlas('da schoolhouse/sprites/BALDI', 'shared');
				frames = tex;
				iconColor = '00DD3B';
			...
			case 'baldihappy':
				tex = Paths.getSparrowAtlas('da schoolhouse/sprites/baldihappy', 'shared');
				frames = tex;
				iconColor = '00DD3B';
			...
			case 'redbald':
				tex = Paths.getSparrowAtlas('da schoolhouse/sprites/redbald', 'shared');
				frames = tex;
				iconColor = 'FF2300';
			...
			case 'bf-paldo':
				var tex = Paths.getSparrowAtlas('da schoolhouse/sprites/BOYFRIENDPALDO', 'shared');
				frames = tex;
